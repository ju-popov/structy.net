...
import (
	...
	pairedparentheses "github.com/ju-popov/structy.net/065-paired-parentheses"
)
...
func TestIterative(t *testing.T) {
	...
	for _, testCase := range testCases {
		...
		t.Run(testCase.name, func(t *testing.T) {
			t.Parallel()
			actual := pairedparentheses.Iterative(testCase.str)
...
func benchmarkIterative(b *testing.B, testCase testCase) {
	...
	for n := 0; n < b.N; n++ {
		pairedparentheses.Iterative(testCase.str)
	}
}
