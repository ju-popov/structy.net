...
import (
	...
	decompressbraces "github.com/ju-popov/structy.net/067-decompress-braces"
)
...
func TestIterative(t *testing.T) {
	...
	for _, testCase := range testCases {
		...
		t.Run(testCase.name, func(t *testing.T) {
			t.Parallel()
			actual := decompressbraces.Iterative(testCase.s)
...
func benchmarkIterative(b *testing.B, testCase testCase) {
	...
	for n := 0; n < b.N; n++ {
		decompressbraces.Iterative(testCase.s)
	}
}
