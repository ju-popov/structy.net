...
import (
	...
	createcombinations "github.com/ju-popov/structy.net/071-create-combinations"
)
...
func TestRecursive(t *testing.T) {
	...
	for _, testCase := range testCases {
		...
		t.Run(testCase.name, func(t *testing.T) {
			t.Parallel()
			actual := createcombinations.Recursive(testCase.items, testCase.k)
...
func benchmarkRecursive(b *testing.B, testCase testCase) {
	...
	for n := 0; n < b.N; n++ {
		createcombinations.Recursive(testCase.items, testCase.k)
	}
}
