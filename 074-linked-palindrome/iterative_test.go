...
import (
	...
	linkedpalindrome "github.com/ju-popov/structy.net/074-linked-palindrome"
)
...
func TestIterative(t *testing.T) {
	...
	for _, testCase := range testCases {
		...
		t.Run(testCase.name, func(t *testing.T) {
			t.Parallel()
			actual := linkedpalindrome.Iterative(testCase.head)
...
func benchmarkIterative(b *testing.B, testCase testCase) {
	...
	for n := 0; n < b.N; n++ {
		linkedpalindrome.Iterative(testCase.head)
	}
}
