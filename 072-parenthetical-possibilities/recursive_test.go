...
import (
	...
	parentheticalpossibilities "github.com/ju-popov/structy.net/072-parenthetical-possibilities"
)
...
func TestRecursive(t *testing.T) {
	...
	for _, testCase := range testCases {
		...
		t.Run(testCase.name, func(t *testing.T) {
			t.Parallel()
			actual := parentheticalpossibilities.Recursive(testCase.s)
...
func benchmarkRecursive(b *testing.B, testCase testCase) {
	...
	for n := 0; n < b.N; n++ {
		parentheticalpossibilities.Recursive(testCase.s)
	}
}
