...
import (
	...
	befittingbrackets "github.com/ju-popov/structy.net/066-befitting-brackets"
)
...
func TestIterative(t *testing.T) {
	...
	for _, testCase := range testCases {
		...
		t.Run(testCase.name, func(t *testing.T) {
			t.Parallel()
			actual := befittingbrackets.Iterative(testCase.str)
...
func benchmarkIterative(b *testing.B, testCase testCase) {
	...
	for n := 0; n < b.N; n++ {
		befittingbrackets.Iterative(testCase.str)
	}
}
